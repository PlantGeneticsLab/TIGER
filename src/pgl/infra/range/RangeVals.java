...
/**
 * Data structure for a list of {@link RangeVal}
 * @author feilu
 */
public class RangeVals extends RangesAbstract {
    ...
    /**
     * Constructs a {@link RangeVals} object from a list of {@link Range}
     * @param ranges 
     */
    ...
    /**
     * Constructs a {@link RangeVals} object with custom parameters
     * @param infileS
     * @param format
     */
    ...
    /**
     * Constructs a {@link RangeVals} object with default, txt file or file ending with ".gz", with a header
     * @param infileS 
     */
